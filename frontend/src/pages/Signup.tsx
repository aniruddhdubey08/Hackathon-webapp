...
import { User, ArrowRight, Eye, EyeOff, ShieldCheck } from 'lucide-react';
            ...
            <div style={styles.card}>
                ...
                <div style={styles.header}>
                    <div style={styles.logoBadge}>
                        <ShieldCheck size={24} color="#00F090" />
                    </div>
                    <h1 style={styles.title}>Cosmic Learning</h1>
                    <p style={styles.subtitle}>SIGN UP // NEW EXPLORER</p>
                </div>

                {/* Form */}
                <div style={styles.form}>
                    <div style={styles.inputGroup}>
                        <label style={styles.label}>CHOOSE EXPLORER ID</label>
                        <div style={styles.inputWrapper}>
                            <input
                                type="text"
                                placeholder="DESIRED_CODENAME"
                                style={styles.input}
                            />
                    ...
                    <div style={styles.inputGroup}>
                        <label style={styles.label}>SET ACCESS KEY</label>
                        <div style={styles.inputWrapper}>
                            <input
                ...
                <div style={styles.footer}>
                    <p style={styles.footerText}>
                        Existing explorer? <button style={styles.linkButton} onClick={() => navigate('/auth')}>ACCESS TERMINAL</button>
                    </p>
                </div>

                {/* System Status - Bottom */}
                <div style={styles.systemStatus}>
                    SYSTEM STATUS: OPTIMAL • REGISTRY OPEN
                </div>
            </div>
        </div>
    );
...
const styles: Record<string, React.CSSProperties> = {
    ...
    logoBadge: {
        ...
        height: '56px',
        borderRadius: '16px',
        backgroundColor: 'rgba(0, 240, 144, 0.1)', // Green/Cyan for login
        display: 'flex',
        alignItems: 'center',
        justifyContent: 'center',
        marginBottom: '20px',
        boxShadow: '0 0 20px rgba(0, 240, 144, 0.2)',
    ...
    subtitle: {
        fontSize: '12px',
        color: '#FF5CB0', // Pink accent for contrast or keep cyan?
        // Let's swap colors for variety.
        letterSpacing: '2px',
        fontWeight: '600',
    ...
    submitButton: {
        marginTop: '16px',
        width: '100%',
        backgroundColor: '#00F090', // Green button for signup
        border: 'none',
        borderRadius: '12px',
        padding: '16px',
        color: '#00331F',
        ...
        justifyContent: 'center',
        gap: '8px',
        boxShadow: '0 0 20px rgba(0, 240, 144, 0.4)',
        fontFamily: 'var(--font-display)',
    },
    divider: {
        display: 'flex',
